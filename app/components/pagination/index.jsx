...
const activeButton =
  "relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg bg-gray-900 text-center align-middle font-sans text-xs font-medium uppercase text-[#000] shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none";
...
const Pagination = () => {
  ...
  return (
    <div class="flex items-center gap-4 justify-end  mt-10">
      <button
        disabled
      ...
      <div class="flex items-center gap-2">
        <a class={button} onClick={handlePage(1)}>
          <span class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
            {1}
          </span>
        </a>
        <a class={button} onClick={handlePage(2)}>
          <span class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
            {1}
          </span>
        </a>
